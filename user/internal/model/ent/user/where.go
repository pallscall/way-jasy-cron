...
// Rtime applies equality check predicate on the "rtime" field. It's identical to RtimeEQ.
func Rtime(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldRtime), v))
	})
}
...
// RtimeEQ applies the EQ predicate on the "rtime" field.
func RtimeEQ(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldRtime), v))
	})
}

// RtimeNEQ applies the NEQ predicate on the "rtime" field.
func RtimeNEQ(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.NEQ(s.C(FieldRtime), v))
	})
}

// RtimeIn applies the In predicate on the "rtime" field.
func RtimeIn(vs ...time.Time) predicate.User {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.User(func(s *sql.Selector) {
		...
		s.Where(sql.In(s.C(FieldRtime), v...))
	})
}

// RtimeNotIn applies the NotIn predicate on the "rtime" field.
func RtimeNotIn(vs ...time.Time) predicate.User {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.User(func(s *sql.Selector) {
		...
		s.Where(sql.NotIn(s.C(FieldRtime), v...))
	})
}

// RtimeGT applies the GT predicate on the "rtime" field.
func RtimeGT(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.GT(s.C(FieldRtime), v))
	})
}

// RtimeGTE applies the GTE predicate on the "rtime" field.
func RtimeGTE(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.GTE(s.C(FieldRtime), v))
	})
}

// RtimeLT applies the LT predicate on the "rtime" field.
func RtimeLT(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.LT(s.C(FieldRtime), v))
	})
}

// RtimeLTE applies the LTE predicate on the "rtime" field.
func RtimeLTE(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.LTE(s.C(FieldRtime), v))
	})
}

// RtimeIsNil applies the IsNil predicate on the "rtime" field.
func RtimeIsNil() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.IsNull(s.C(FieldRtime)))
	})
}

// RtimeNotNil applies the NotNil predicate on the "rtime" field.
func RtimeNotNil() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.NotNull(s.C(FieldRtime)))
	})
}
